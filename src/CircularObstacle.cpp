...
void CircularObstacle::setBoundaries(int w) {
...
void CircularObstacle::setEquivalentSources(int w) {
  FLOAT wl = wave_lenghts[w];
...
CircularObstacle::CircularObstacle(FLOAT r):  Obstacle(), radius(r) {}

CircularObstacle::CircularObstacle(VEC2 p, FLOAT r) :  Obstacle(p), radius(r) {}
